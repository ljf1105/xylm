...
public class WoDeQuanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wo_de_quan);
        initView();
        ToolBarUtils.newInstance().setToolBar(this, fy_toolbar,fy_text,"帖子");
    }
    ...
    protected int getLayoutId() {
        return R.layout.activity_wo_de_quan;
    }
