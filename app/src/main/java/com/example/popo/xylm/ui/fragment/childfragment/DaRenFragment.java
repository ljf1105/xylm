 ...
 */
public class DaRenFragment extends BaseFragment<HomeModel, HomePresenter> implements HomeContract.View {
    ...
    protected void initView(View view) {
        ...
        mPresenter.getMshiData(Keys.DAREN);

    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_da_ren;
    }
