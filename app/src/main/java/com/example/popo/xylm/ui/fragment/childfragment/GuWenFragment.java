 ...
 */
public class GuWenFragment extends BaseFragment<HomeModel,HomePresenter> implements HomeContract.View {
    ...
    protected void initView(View view) {
        ...
        mPresenter.getMshiData(Keys.GUWEN);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_gu_wen;
    }
}
