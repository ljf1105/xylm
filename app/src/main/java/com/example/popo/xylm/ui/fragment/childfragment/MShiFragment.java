 ...
 */
public class MShiFragment extends BaseFragment<HomeModel,HomePresenter> implements HomeContract.View {
    ...
    protected void initView(View view) {
        ...
        mPresenter.getMshiData(Keys.MINGSHI);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_mshi;
    }
